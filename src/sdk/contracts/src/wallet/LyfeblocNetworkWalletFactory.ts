...
export interface LyfeblocNetworkWalletFactoryInterface extends utils.Interface {
  functions: {
...
export interface LyfeblocNetworkWalletFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LyfeblocNetworkWalletFactoryInterface;
