...
export interface LyfeblocNetworkWalletInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "LyfeblocNetworkWalletInitialized(address,address)": EventFragment;
    "LyfeblocNetworkWalletReceived(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "LyfeblocNetworkWalletInitialized"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "LyfeblocNetworkWalletReceived"): EventFragment;
...
export type LyfeblocNetworkWalletInitializedEvent = TypedEvent<
  [string, string],
...
export type LyfeblocNetworkWalletReceivedEvent = TypedEvent<
  [string, BigNumber],
...
export interface LyfeblocNetworkWallet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LyfeblocNetworkWalletInterface;
