...
import type { IBLSAccount, IBLSAccountInterface } from '../../../../src/aa-4337/bls/IBLSAccount';
...
export class IBLSAccount__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IBLSAccount {
