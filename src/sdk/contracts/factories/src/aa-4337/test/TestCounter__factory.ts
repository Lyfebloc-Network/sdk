...
import type { TestCounter, TestCounterInterface } from '../../../../src/aa-4337/test/TestCounter';
...
export class TestCounter__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<TestCounter> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): TestCounter {
