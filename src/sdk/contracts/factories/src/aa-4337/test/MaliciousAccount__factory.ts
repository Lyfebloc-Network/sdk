...
import type { MaliciousAccount, MaliciousAccountInterface } from '../../../../src/aa-4337/test/MaliciousAccount';
...
const isSuperArgs = (xs: MaliciousAccountConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
