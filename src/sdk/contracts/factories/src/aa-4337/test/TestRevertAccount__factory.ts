...
import type { TestRevertAccount, TestRevertAccountInterface } from '../../../../src/aa-4337/test/TestRevertAccount';
...
type TestRevertAccountConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: TestRevertAccountConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
