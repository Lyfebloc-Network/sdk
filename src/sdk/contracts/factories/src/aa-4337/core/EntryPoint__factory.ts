...
import type { EntryPoint, EntryPointInterface } from '../../../../src/aa-4337/core/EntryPoint';
...
export class EntryPoint__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<EntryPoint> {
