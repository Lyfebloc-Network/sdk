...
import type { SenderCreator, SenderCreatorInterface } from '../../../../src/aa-4337/core/SenderCreator';
...
export class SenderCreator__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<SenderCreator> {
